...
class SingleTaskWithOtherAffinityActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySingleTaskWithOtherAffinityBinding
    private val TAG = SingleTaskWithOtherAffinityActivity::class.java.simpleName
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySingleTaskWithOtherAffinityBinding.inflate(layoutInflater)
    ...
    private fun setListener() = with(binding) {
        listOf(
            ...
            btn.setOnClickListener {
                val intent = Intent(this@SingleTaskWithOtherAffinityActivity, cls)
